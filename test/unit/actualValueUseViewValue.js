...
describe('provider with use-view-value to false', function() {
  var $rootScope;
  var $compile;
  var $scope;
  var $timeout;
  ...
  beforeEach(inject(function($injector) {
    ...
    element = $compile('<form name="Form"><input type="number" use-view-value="false" name="numberWatch" ng-model="number" validator="number" email-error-message="Error Number" email-success-message="Good Number"/></form>')($scope);
